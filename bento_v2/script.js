...
const PRODUCT_I18N = {
    ...
    "87429": {
        ...
        "vi": { name: "Salad Hoa Quả Trộn Sốt Xí Muội Chua Ngọt", desc: "Món khai vị chua ngọt kích thích vị giác! Sốt xí muội đá kết hợp hoa quả thanh mát, bổ dưỡng." }
    },
    "91945": {
    ...
    "76513": {
        "zh-TW": { name: "Sunny主廚客製會議精緻餐盒", desc: "針對公司行號會議、貴賓研討會客製的精緻雙主菜餐盒，提供 200元/250元 雙規格供預算調配！(需提早預定)" },
        "en": { name: "Sunny Chef's Customized Catering Box", desc: "Premium double-entree lunchbox tailored for business meetings and VIP workshops. TWD 200 / 250 tiers available." },
        "th": { name: "กล่องอาหารจัดประชุมของเชฟซันนี่", desc: "กล่องข้าวอาหารกล่องสองหน้าคัดเกรด VIP สำหรับงานประชุมและงานสัมมนา เลือกราคาได้ระหว่าง 200/250 TWD" },
        "vi": { name: "Hộp Cơm Hội Nghị Cao Cấp Chef Sunny", desc: "Hộp cơm 2 món chính cao cấp thiết kế cho hội nghị doanh nghiệp và hội thảo VIP. Tùy chọn phân khúc 200 / 250 TWD." }
    },
    "38575": {
        "zh-TW": { name: "【特惠公告】感謝銀行電子袁董事長體恤員工補助餐費", desc: "賀！每月伙食津貼外，袁董事長體恤員工辛苦，特額外補貼員工到店食堂點餐 *30元* 餐費！好人一生平安！" },
        "en": { name: "【Benefit Notice】Thanks to Bank Electronics Chairman for Subsidy", desc: "Bonus! Chairman subsidized TWD 30 for employee cafeteria orders, in addition to standard meal allowances. Bless him!" },
        "th": { name: "【ประกาศสวัสดิการ】ขอบคุณประธานบริษัท Bank Electronics สนับสนุนค่าอาหาร", desc: "ยินดีด้วย! ประธานสนับสนุนสวัสดิการช่วยจ่ายค่าอาหารเพิ่ม 30 TWD ต่อมื้อสำหรับพนักงานในโรงอาหารนอกเหนือจากสวัสดิการเดิม!" },
        "vi": { name: "【Tin Đặc Biệt】Cảm ơn Chủ Tịch Bank Electronics hỗ trợ phụ cấp ăn trưa", desc: "Tin vui! Phụ cấp thêm 30 TWD/suất ăn tại nhà ăn cho nhân viên bên cạnh trợ cấp ăn uống tiêu chuẩn hàng tháng!" }
    },
    "38577": {
